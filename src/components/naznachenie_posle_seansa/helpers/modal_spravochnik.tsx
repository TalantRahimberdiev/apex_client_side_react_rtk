...
export default function ModalSpravochnik({ set_element, spravochnik, add_spravochnik_element, remove_spravochnik_element }: Interface_modal_props) {
         ...
         <Flex mih={50} gap="lg" justify="flex-start" align="end" mt={'lg'}>
            {
               spravochnik.pk === 11 ? (
                  ...
                  <Input style={{width:'55vw'}} type="text" value={selected_spravochnik_element} readOnly />
               </Input.Wrapper>
               ):(
                  <Input.Wrapper>
                  <Title order={6}>{spravochnik.spravochnik_title}</Title>
