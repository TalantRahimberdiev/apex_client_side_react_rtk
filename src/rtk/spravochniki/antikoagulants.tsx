...
const initialState: Interface_spravochniks = {
   pk: 10,
   spravochnik_title: 'Антикоагулянты',
   spravochnik_elements: ['антикоагуляция_1', 'антикоагуляция_2', 'антикоагуляция_3', 'антикоагуляция_4'],
}

export const slice_antikoagulants = createSlice({
   name: 'antikoagulants',
   initialState,
   reducers: {
...
export const { add_spravochnik_element, remove_spravochnik_element } = slice_antikoagulants.actions
export default slice_antikoagulants.reducer